...
import { retrieve, update, reset } from '../../actions/company/update';
...
const mapStateToProps = state => ({
  retrieved: state.company.update.retrieved,
  retrieveError: state.company.update.retrieveError,
  retrieveLoading: state.company.update.retrieveLoading,
  ...
  created: state.company.create.created,
